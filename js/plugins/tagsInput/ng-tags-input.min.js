...
(function () {
    ...
    tagsInput.directive('tagsInput', ["$timeout", "$document", "$window", "tagsInputConfig", "tiUtil", function ($timeout, $document, $window, tagsInputConfig, tiUtil) {
        function TagList(options, events, onTagAdding, onTagRemoving) {
            ...
            self.changeTag = function (oldTag, newTag) {
                var index = self.items.indexOf(oldTag);
                if (index == -1) return;
                var tagText = getTagText(newTag);
                ...
                setTagText(newTag,firstText);
                self.items[index] = newTag;
                addTextArr(textArr);
            }
        ...
        return {
            ...
            link: function (scope, element, attrs, ngModelCtrl) {
                ...
                scope.doubleClick = function (tag) {
                    tag.editable = true;
                    scope.editing = true;
                ...
                scope.eventHandlers = {
                    ...
                    host: {
                        click: function () {
                            if (scope.disabled || scope.editing) {
                                return;
                            }
                            input[0].focus();
                        }
